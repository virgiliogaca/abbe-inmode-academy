    ...
    return (
        <>
            ...
            xs:w-[290px] xs:h-10">
                ...
                xs:text-3xl xs:ml-[80px]">REGISTRO</text>
            </div>
            <div>
                <div class="
                xl:mt-16 xl:-ml-24 
            ...
            xs:w-[380px] xs:h-72 xs:-ml-11 xs:mt-52">
                ...
                xs:ml-14 xs:-mt-36 xs:w-[274px] xs:h-44">
                    ...
                    xl:ml-4">
                        ...
                        lg:ml-14 
                        md:ml-14
                        xs:ml-14">{'A TODOS LOS QUE LLEVEN'}</text>
                        <br />
                        <text class="text-white font-normal text-sm 
                        xl:ml-[52px] 
                        lg:ml-[52px] 
                        md:ml-[52px]
                        xs:ml-[52px]">{'DE UN KIT DE AGUJAS CON'}</text>
                        <br />
                        <text class="text-white font-extralight text-sm 
                        xl:ml-4 
                        lg:ml-4 
                        ...
                        lg:ml-8 
                        md:ml-8
                        xs:ml-8">A LAS CONFERENCIAS RECIBIRÁN</text>
                        <br />
                        <text class="text-white font-normal text-xs 
                        xl:ml-14 
                        lg:ml-14 
                        md:ml-14
                        xs:ml-14">UN VALE POR UNA CAJA DE</text>
                        <img class='
                        xl:w-28 
                        xl:ml-[75px] 
                        lg:w-28 lg:ml-[75px] 
                        md:w-28 md:ml-[75px]
                        xs:w-28 xs:ml-[75px]' src={morpheus} alt="" />
                        <text class="text-white font-normal text-xs 
                        xl:ml-3 
                        lg:ml-3 
                        md:ml-3
                        xs:ml-3">UN BOLETO PARA LA RIFA DE UN CABEZAL DE</text>
                ...
                xs:ml-4">
                    ...
                    lg:ml-16 
                    md:ml-16
                    xs:ml-16">**SE VERIFICARA EL NÚMERO AL</text>
                    <br />
                    <text class="text-black font-normal text-md 
                    xl:ml-24 
                    lg:ml-24 
                    md:ml-24
                    xs:ml-24">MOMENTO DE LA RIFA</text>
                </div>
                <div class="
                xl:mt-16 xl:ml-32 
                lg:mt-16 lg:ml-28 
